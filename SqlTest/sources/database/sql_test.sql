...
CREATE TABLE `albums` (
  ...
  `2022 Sales` decimal(9,2) DEFAULT NULL,
  `Date Released` int(6) DEFAULT NULL,
  `Last Update` int(6) DEFAULT NULL
...
INSERT INTO `albums` (`Artist`, `Album`, `2022 Sales`, `Date Released`, `Last Update`) VALUES
